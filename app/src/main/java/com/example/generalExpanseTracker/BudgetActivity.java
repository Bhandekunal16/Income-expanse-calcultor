...
public class BudgetActivity extends BaseActivity {
    ...
    private TextView txtBudget, txtSpent, txtRemaining;
    ...
    private void updateUI() {
        ...
        Log.d("PROGRESS_CHECK", "Spent=" + totalSpent + " Budget=" + totalBudget);
        ...
        if (totalBudget > 0) {
            ...
            NotificationHelper.showNotification(this, "Budget Summary", message);
